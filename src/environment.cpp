...
void simpleHighway(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
    ...
    //renderPointCloud(viewer,inputCloud,"myPCD");
...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
  ...
  pcl::PointCloud<pcl::PointXYZI>::Ptr filterCloud = pointProcessorI->FilterCloud(inputCloud, 0.28, Eigen::Vector4f (-10,-5,-3,1), Eigen::Vector4f (30,7,2,1));
...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer , ProcessPointClouds<pcl::PointXYZI>* pointProcessorI,pcl::PointCloud<pcl::PointXYZI>::Ptr inputCloud )
{
  ...
  //renderPointCloud(viewer,inputCloud,"inputCloud");
    ...
    //-----------------------------
    //--RansacPlane for project ---
    //-----------------------------
    std::pair<pcl::PointCloud<pcl::PointXYZI>::Ptr,pcl::PointCloud<pcl::PointXYZI>::Ptr> segmentCloud = pointProcessorI->RansacPlane(filterCloud,50,0.3);
    renderPointCloud(viewer,segmentCloud.first,"obstCloud",Color(0,0,1));
    renderPointCloud(viewer,segmentCloud.second,"planeCloud",Color(0,1,0));
    //-----------------------------
